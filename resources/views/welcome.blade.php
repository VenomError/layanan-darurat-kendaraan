                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div
                            ...
                            data-wow-delay="0.3"
                        >
                            <h1 class="display-5 text-white">Rent Luxury Cars on the Lowest Price</h1>
                            <P class="text-white">Your ultimate destination for all things help you celebrate & remember
                                tour experience.</P>
                        </div>
                        <div
                            class="banner-form card wow fadeInUp mb-0"
                            data-wow-delay="1.5"
                        >
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="tab-content">
                                        ...
                                        >
                                            <form
                                                action="https://dreamstour.dreamstechnologies.com/html/flight-grid.html"
                                            >
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-check d-flex align-items-center mb-2 me-3">
                                                            <input
                                                ...
                                                <div class="normal-trip">
                                                    <div class="d-lg-flex">
                                                        <div class="d-flex form-info">
                                                                ...
                                                                <div class="dropdown-menu dropdown-md p-0">
                                                                    <div class="input-search border-bottom p-3">
                                                                        <div class="input-group">
                                                                            ...
                                                                            >
                                                                            <span
                                                                                class="input-group-text border-start-0 px-2"
                                                                            ><i
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li class="border-bottom">
                                                                            <a
                                                                                ...
                                                                                href="javascript:void(0);"
                                                                            >
                                                                                <h6 class="fs-16 fw-medium">Los Angeles
                                                                                </h6>
                                                                        ...
                                                                        <li class="border-bottom">
                                                                            <a
                                                                                ...
                                                                                href="javascript:void(0);"
                                                                            >
                                                                                <h6 class="fs-16 fw-medium">Orlando
                                                                                </h6>
                                                            ...
                                                            <div class="form-item dropdown ps-sm-3 ps-2">
                                                                <div
                                                                    data-bs-toggle="dropdown"
                                                                    data-bs-auto-close="outside"
                                                                    aria-expanded="false"
                                                                    ...
                                                                    <ul>
                                                                        <li class="border-bottom">
                                                                            <a
                                                                                ...
                                                                                href="javascript:void(0);"
                                                                            >
                                                                                <h6 class="fs-16 fw-medium">Newyork
                                                                                </h6>
                                                                                <p>Ken International Airport</p>
                                                                            </a>
                                                                        </li>
                                                            ...
                                                            <div class="form-item dropdown">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="br-10 info-item mb-3 border pb-1">
                                                                        <h6 class="fs-16 fw-medium mb-2">Travellers
                                                                        </h6>
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        class="form-label text-gray-9 mb-2"
                                                                                    >Adults
                                                                                        <span
                                        ...
                                        >
                                            <form
                                                action="https://dreamstour.dreamstechnologies.com/html/hotel-grid.html"
                                            >
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                                            ...
                                                            <div class="dropdown-menu dropdown-md p-0">
                                                                <div class="input-search border-bottom p-3">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <span
                                                                            class="input-group-text border-start-0 px-2"
                                                                        ><i class="isax isax-search-normal"></i></span>
                                                                    </div>
                                                                </div>
                                                                <ul>
                                                                    <li class="border-bottom">
                                                                ...
                                                                <ul>
                                                                    <li class="border-bottom">
                                                                        <a
                                                                            ...
                                                                            href="javascript:void(0);"
                                                                        >
                                                                            <h6 class="fs-16 fw-medium">$500 - $2000
                                                                            </h6>
                                                                            <p>Upto 65% offers</p>
                                                                        </a>
                                                                    </li>
                                                                    ...
                                                                    <li class="border-bottom">
                                                                        <a
                                                                            ...
                                                                            href="javascript:void(0);"
                                                                        >
                                                                            <h6 class="fs-16 fw-medium">$5000 - $8000
                                                                            </h6>
                                                                            <p>Upto 35% offers</p>
                                                                        </a>
                                                                    </li>
                                                                    <li class="border-bottom">
                                                                        <a
                                                                            ...
                                                                            href="javascript:void(0);"
                                                                        >
                                                                            <h6 class="fs-16 fw-medium">$9000 - $11000
                                                                            </h6>
                                                                            <p>Upto 20% offers</p>
                                                                        </a>
                                                                    </li>
                                        ...
                                        >
                                            <form
                                                action="https://dreamstour.dreamstechnologies.com/html/car-grid.html">
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        <div class="form-check d-flex align-items-center mb-2 me-3">
                                                ...
                                                <div class="d-lg-flex">
                                                    <div class="d-flex form-info">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="border-bottom">
                                                                        <a
                                                                            ...
                                                                            href="javascript:void(0);"
                                                                        >
                                                                            <h6 class="fs-16 fw-medium">London Heathrow
                                                                            </h6>
                                                                            <p>UK</p>
                                                                        </a>
                                                                    </li>
                                                                    <li class="border-bottom">
                                                                        <a
                                                                            ...
                                                                            href="javascript:void(0);"
                                                                        >
                                                                            <h6 class="fs-16 fw-medium">Seoul Incheon
                                                                            </h6>
                                                                            <p>South Korea</p>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a
                                                                            ...
                                                                            href="javascript:void(0);"
                                                                        >
                                                                            <h6 class="fs-16 fw-medium">Singapore
                                                                                Changi
                                                                                International</h6>
                                                                            <p>Singapore</p>
                                                                        </a>
                                                        ...
                                                        <div class="form-item dropdown to-location ps-sm-3 ps-2">
                                                            <div
                                                                data-bs-toggle="dropdown"
                                                                data-bs-auto-close="outside"
                                                                aria-expanded="false"
                                        ...
                                        >
                                            <form
                                                action="https://dreamstour.dreamstechnologies.com/html/cruise-grid.html"
                                            >
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                        ...
                                        >
                                            <form
                                                action="https://dreamstour.dreamstechnologies.com/html/tour-grid.html"
                                            >
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                                    <h6 class="fw-medium fs-16 mb-2">Search holiday packages & trips
                                                    </h6>
                                                </div>
                                                <div class="d-lg-flex">
                                                    <div class="d-flex form-info">
