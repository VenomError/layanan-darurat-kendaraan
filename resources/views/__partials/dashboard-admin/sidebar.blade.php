...
<div class="main-sidebar" id="main-sidebar">
    <div class="sidebar-wrapper">
        <a class="navbar-brand" href="{{ route('dashboard') }}">
            <div class="logo-lg">
                <x-img
                    ...
                    src="dashboard/assets/images/main-logo.png"
                    alt=""
                    aria-label="logo"
                    loading="lazy"
                    height="24"
                ...
                <x-img
                    ...
                    src="dashboard/assets/images/logo-white.png"
                    alt=""
                    aria-label="logo"
                    loading="lazy"
                    height="24"
            ...
            <div class="logo-sm">
                <x-img
                    class="logo-dark mx-auto"
                    src="dashboard/assets/images/logo-sm-dark.png"
                    alt=""
                    aria-label="logo"
                    loading="lazy"
                    height="24"
                ...
                <x-img
                    class="logo-light mx-auto"
                    src="dashboard/assets/images/logo-sm-white.png"
                    alt=""
                    aria-label="logo"
                    loading="lazy"
                    height="24"
        ...
        <div class="dropdown profile-dropdown">
            <a class="btn d-flex align-items-center w-100 gap-2 p-4 text-start" data-bs-toggle="dropdown" href="#!"
                aria-expanded="false"
            >
                <img class="size-10 rounded" src="dashboard/assets/images/user-45.png" alt="" loading="lazy">
            ...
            <div class="dropdown-menu profile-dropdown-menu p-4">
                <div class="d-flex align-items-center gap-2">
                    <img class="rounded-circle size-10 flex-shrink-0" src="dashboard/assets/images/user-17.png" alt=""
                        loading="lazy"
                    >
        ...
        <div class="navbar-menu px-5" id="navbar-menu-list" data-simplebar>
            <ul class="list-unstyled navbar-nav-menu p-0">
                @include('__partials.dashboard-admin.sidebar-admin')
            </ul>
        </div>
    </div>
</div>
