                ...
                <div class="col">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li>
                                <a href="pricing-plan.html">Pricing Plans</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="agent-listings.html">Listings</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="footer-wrap bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-xl-3 col-xxl-3">
                        <div class="text-xl-start mb-3 text-center">
                            <a
                                href="index.html"
                                class="d-block footer-logo-light"
                            >
                                <img
                    ...
                    <div class="col-lg-6 col-xl-4 col-xxl-4">
                        <div class="d-flex align-items-center justify-content-center flex-wrap">
                            <h6 class="fs-14 fw-medium mb-2 me-2">Available on : </h6>
                            <a
                                href="javascript:void(0);"
                                class="d-block mb-3 me-2"
                            >
                                <img
                    ...
                    <div class="col-lg-12 col-xl-5 col-xxl-5">
                        <div class="d-sm-flex align-items-center justify-content-center justify-content-xl-end">
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-sm-start me-sm-3 pe-sm-3 border-end mb-3 me-0 pe-0">
                            ...
                            <div class="d-flex align-items-center justify-content-center justify-content-sm-start mb-3">
                                ...
                                <div class="ms-2">
                                    ...
                                    <p class="fw-medium text-dark"><a
                                            ...
                                            class="__cf_email__"
                                            data-cfemail="660f08000926031e070b160a034805090b"
                                        >[email&#160;protected]</a></p>
                                </div>
                            </div>
                        </div>
